export const portfolio = {
  ...
  projects: [
    {
      name: 'AI Online Proctoring',
      desc: 'An intelligent proctoring system with real-time face and behavior monitoring.',
      href: '#contact',
    },
    {
      name: 'Student Management System',
      desc: 'A web-based system for managing students, courses, and academic records.',
      href: '#contact',
    },
    {
      name: 'Portfolio Website',
      desc: 'A personal portfolio to showcase my work and journey as a developer.',
      href: '#contact',
    },
  ],
};
